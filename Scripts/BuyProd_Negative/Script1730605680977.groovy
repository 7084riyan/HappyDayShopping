...
Mobile.tap(findTestObject('BuyProd_positif/android.widget.TextView - Promo - Afficionado 12  Extract Soap'), 0)

Mobile.clearText(findTestObject('BuyProd_negatif/android.widget.EditText - 1'), 0)

Mobile.tap(findTestObject('Object Repository/BuyProd_positif/android.widget.TextView - Add to Bag'), 0)

Mobile.verifyElementExist(findTestObject('Object Repository/BuyProd_positif/notif_add'), 3, FailureHandling.CONTINUE_ON_FAILURE)
